...
declare PSQL_POSTMASTER="/usr/pgsql-9.1/bin/postmaster"
declare PSQL_CTL="/usr/pgsql-9.1/bin/pg_ctl"
...
start()
{
	...
	touch $PSQL_pid_file
	chown $OCF_RESKEY_postmaster_user $PSQL_pid_file
	chgrp $pguser_group $PSQL_pid_file
